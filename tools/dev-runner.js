...
const tasks = [
  ...
  command: 'pnpm run build:ordered && pnpm run postbuild:clean',
  ...
  },
  {
    ...
    command: 'pnpm --filter @n00plicate/design-tokens run watch',
  ...
  },
  {
    ...
    description: 'Generate dependency plan (dependency audit)',
  },
  {
    id: 'deps-verify',
    label: '🛡️ deps:verify',
